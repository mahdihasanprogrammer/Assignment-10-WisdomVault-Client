...
export default function AuthorCard({ lesson }) {
  return (
    <Card className="bg-gradient-to-b from-[#0d071f] to-[#060211] border border-white/5 p-5 rounded-3xl shadow-xl text-left w-full">
      <div className="flex flex-col gap-4 items-start">
        ...
        {/* টোটাল লেসন কাউন্টার */}
        <div className="w-full bg-white/[0.02] border border-white/5 p-3 rounded-xl flex items-center justify-between text-xs">
          <span className="text-white/40">Contributions:</span>
          <span className="font-bold text-purple-400 bg-purple-500/10 px-2 py-0.5 rounded-md">14 Lessons</span>
        </div>
