                    ...
                    <SwiperSlide key={index} className="w-full">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-95">
                            ...
                            <div className="lg:col-span-6 w-full flex items-center justify-center relative group/box">
                                <div className="relative w-full aspect-video lg:aspect-square lg:max-w-md rounded-3xl overflow-hidden bg-white/0.5 border border-white/10 shadow-2xl p-2 flex items-center justify-center">
                                    <Image
                                        src={slide.imgSrc}
