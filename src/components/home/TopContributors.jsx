            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl sm:text-6xl font-black tracking-tight text-white mt-4">
                        Top{" "}
                        <span className="bg-linear-to-r from-purple-400 via-pink-400 to-amber-300 bg-clip-text text-transparent">
                            Contributors
                        </span>
                    </h2>

                    <p className="mt-4 text-sm text-white/50 font-medium">
                        Rankings are based on approved lessons published in the last 7 days.
                    </p>
                </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between w-full mb-8">
                                        ...
                                        <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-mono font-black tracking-widest uppercase border ${isPremium
